...
//-----------------------------------------------------------------------------
// Purpose: Game system that handles item generation.
//-----------------------------------------------------------------------------
...
public:
    ...
    CBaseEntity* GenerateRandomItem(CItemSelectionCriteria* pCriteria, const Vector& vecOrigin, const QAngle& vecAngles, const char* pszOverrideClassName = nullptr);
...
private:
    // Create a new instance of the chosen item using definition index.
    ...
    // Create a new instance of an item from item data.
    ...
    // Finalize the spawned item: set origin/angles, spawn, activate.
