...
//-----------------------------------------------------------------------------
// Purpose: Stores off all CAttribute_DynamicRecipeComponent attributes that consider
//          m_pTargetItem to be a match. If pTargetItem is nullptr, all attributes match.
//-----------------------------------------------------------------------------
...
public:
    ...
    void SetSourceItem(const IEconItemInterface* pSourceItem);
...
//-----------------------------------------------------------------------------
// Purpose: Given a CAttribute_DynamicRecipeComponent and an IEconItemInterface,
//          returns whether the item passes the criteria of the attribute.
//-----------------------------------------------------------------------------
bool DefinedItemAttribMatch(const CAttribute_DynamicRecipeComponent& attribValue, const IEconItemInterface* pItem);

//-----------------------------------------------------------------------------
// Purpose: Decodes the encoded attributes in attribValue and fills vecAttribs.
...
//-----------------------------------------------------------------------------
// Purpose: Decodes the encoded attributes in attribValue and applies them to pItem,
//          modifying the item as described.
//-----------------------------------------------------------------------------
