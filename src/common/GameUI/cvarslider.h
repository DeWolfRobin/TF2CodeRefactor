...
public:
    ...
    CCvarSlider(vgui::Panel* parent, const char* panelName, const char* caption,
        float minValue, float maxValue, const char* cvarname, bool bAllowOutOfRange = false);
    ~CCvarSlider();

    // Setup slider with the given range, cvar name, and out-of-range option.
