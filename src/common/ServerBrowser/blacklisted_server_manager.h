...
private:
    // Helper function that contains the common logic for adding a server.
    blacklisted_server_t* AddServerInternal(const char* serverName, const netadr_t& netAdr, uint32 timestamp);
